...
\begin{document}
    ...
    \begin{remark}
        ...
        \note{Since the inner product of an inner product space is fixed, we may proceed in the reverse direction of Remark 10.14.}
    ...
    \begin{remark}
        ...
        \note{We shall consistently use $U(n)$ to denote the following group from now on.}
        \begin{equation*}
    ...
    \begin{proof}
        ...
        \note{We shall consistently use $T(n)^+$ to denote the following group from now on.}
        \begin{equation*}
